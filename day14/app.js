...
let result, description, person1, person2;

let calculate = function () {
  result = document.querySelector("#result");
  description = document.querySelector("#description");
  person1 = document.querySelector("#person1").value.toUpperCase();
  person2 = document.querySelector("#person2").value.toUpperCase();
